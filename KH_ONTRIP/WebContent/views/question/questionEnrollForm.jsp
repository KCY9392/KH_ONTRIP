    ...
    <div class="outer">
		...
		<form action="<%=contextPath %>/insert.bo" id="enroll-form" method="post" enctype="multipart/form-data">
			...
			<div align="center">
                <div>
                    <span>제목 : </span>
                    <input type = "text" style="width: 300px; height: 40px;" name = "title" placeholder="제목을 입력해주세요" required>
                </div>
				<div>
                    <span style="vertical-align: top;">내용 :</span>
                    <textarea name="content" style="width: 300px; height: 172px; resize: none;" placeholder="제목을 입력해주세요" style="resize: none;" required></textarea>
                </div>
                <%
                <div>
                    <span>답변 : </span>
