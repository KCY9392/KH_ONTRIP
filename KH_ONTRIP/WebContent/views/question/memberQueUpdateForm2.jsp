...
<div class="container">
  <h2 class="panel-title" style="color:rgb(5, 198, 37);">문의사항 수정</h2> <br>
  <div class="form-group" style="text-align:center;">
    <form method="post" action="/KH_ONTRIP/question/queUpdate">
      <span> 제목 : <input type="text" name="qTitle" value="${qTitle}"> </span> <br><br>
      <span> 내용</span> <br>
      <textarea cols="50" rows="7" name="qContent" >${qContent}</textarea>  <br><br>
      <br><br>
