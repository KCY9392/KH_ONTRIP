...
<%
	...
	String dareaCode = ((String)request.getAttribute("dareaCode"));
%>
...
<%@ include file="../common/managerNavbar.jsp" %> 
   ...
   <form method="post" action="<%= request.getContextPath()%>/PlaceInsert2.mn?placeCode=<%= placeCode %>&categoryCode=<%= categoryCode %>&dareaCode=<%= dareaCode %>" enctype="multipart/form-data">
